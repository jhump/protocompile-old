...
func TestOptionsEncoding(t *testing.T) {
	...
	fdset := testutil.LoadDescriptorSet(t, "../internal/testprotos/options/test.protoset", linker.ResolverFromFile(fds[0]))
	testutil.CheckFiles(t, res, testutil.FileProtoSetFromDescriptorProtos(fdset), false)
